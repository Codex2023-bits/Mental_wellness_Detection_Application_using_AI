                    ...
                    <div class="col-12 d-flex flex-column justify-content-center align-items-center mt-5">
                        <div class="glass_box text-center" style="max-width: 400px; padding: 40px;">
                            ...
                            <% String error=request.getParameter("error"); String
                                success=request.getParameter("success"); if ("session".equals(error)) { %>
                                        ...
                                        <% } %>
                                            ...
                                            <p class="mt-3" style="font-size: 0.85rem; color: #6b7280;">
                                                Don't have an account? <a href="signup.jsp"
                                                    style="color: #10b981; font-weight: 500;">Sign up here</a>
                                            </p>
                                            <p class="mt-1" style="font-size: 0.85rem; color: #9ca3af;">
