            ...
            <div class="row">
                <div class="col-12 d-flex flex-column justify-content-center align-items-center mt-5">
                    <div class="glass_box text-center" style="max-width: 500px;">
                        ...
                        <div style="margin-top: 32px; padding: 24px; background: rgba(255, 255, 255, 0.5); border-radius: 16px; text-align: left;">
                            <div style="margin-bottom: 16px;">
                                <p style="font-size: 0.85rem; color: #6b7280; margin-bottom: 4px;">Email Address</p>
                                <p style="font-weight: 500; font-size: 1.1rem;">
                                    <i class="fa-solid fa-envelope" style="margin-right: 8px; color: #8b5cf6;"></i>
                                    <%= email != null ? email : "Not available" %>
                                </p>
                            </div>
                            <div style="margin-bottom: 16px;">
                                <p style="font-size: 0.85rem; color: #6b7280; margin-bottom: 4px;">Session Started</p>
                            ...
                            <div>
                                <p style="font-size: 0.85rem; color: #6b7280; margin-bottom: 4px;">Session ID</p>
                                <p style="font-weight: 500; font-size: 0.9rem; word-break: break-all;">
                                    <i class="fa-solid fa-fingerprint" style="margin-right: 8px; color: #10b981;"></i>
                                    <%= session.getId() %>
                                </p>
                            </div>
                        </div>
                        <div style="display: flex; gap: 12px; justify-content: center; margin-top: 32px;">
                            ...
                            <a href="dashboard.jsp" class="btn btn-primary"><i class="fa-solid fa-chart-line"></i> Dashboard</a>
