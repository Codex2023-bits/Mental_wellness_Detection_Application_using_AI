        ...
        <body>
            ...
            <div class="ai-chat-widget">
                ...
                <div class="ai-chat-window" id="aiChatWindow">
                    <div class="ai-chat-header">
                        <h4><i class="fa-solid fa-leaf"></i> Wellness Assistant</h4>
                        <button class="report-close-btn" id="hideChatBtn">&times;</button>
                    </div>
                    <div class="ai-chat-messages" id="chatMessages">
                        <div class="chat-msg chat-msg-ai">
                            Hi! I'm your local wellness assistant. How are you feeling today?
                        </div>
                    </div>
                    <div class="ai-chat-input-area">
                        <input type="text" class="ai-chat-input" id="aiChatInput" placeholder="Type a message...">
                        <button class="ai-send-btn" id="sendAiBtn">
            ...
            <script>
                ...
                function appendMessage(text, isAi) {
                    ...
                    msgDiv.className = 'chat-msg ' + (isAi ? 'chat-msg-ai' : 'chat-msg-user');
                ...
                async function sendMessage() {
                    ...
                    // Show typing indicator or simple placeholder
                    ...
                    try {
                        ...
                        if (data.reply) {
                            ...
                            appendMessage("Sorry, I'm having trouble connecting to my brain. Please make sure Ollama is running.", true);
                        }
                    } catch (err) {
                        chatMessages.removeChild(loadingMsg);
                        appendMessage("Connection error. Is the server running?", true);
                    }
                }
